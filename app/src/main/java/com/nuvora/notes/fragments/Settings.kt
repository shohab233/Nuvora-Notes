...
import com.nuvora.notes.MenuDialog
import com.nuvora.notes.Progress
import com.nuvora.notes.R
import com.nuvora.notes.databinding.DialogProgressBinding
import com.nuvora.notes.databinding.FragmentSettingsBinding
import com.nuvora.notes.databinding.PreferenceBinding
import com.nuvora.notes.databinding.PreferenceSeekbarBinding
import com.nuvora.notes.miscellaneous.Operations
import com.nuvora.notes.preferences.*
import com.nuvora.notes.viewmodels.BaseNoteModel
...
class Settings : Fragment() {
    ...
    private fun setupBinding(binding: FragmentSettingsBinding) {
        ...
        binding.AppVersion.setOnClickListener {
            Toast.makeText(requireContext(), "Nuvora Notes v1.0.0", Toast.LENGTH_SHORT).show()
        }
        ...
        binding.Rate.setOnClickListener {
            openLink("https://play.google.com/store/apps/details?id=com.nuvora.notes")
        }
    ...
    private fun exportBackup() {
        ...
        intent.putExtra(Intent.EXTRA_TITLE, "Nuvora Notes Backup")
    ...
    private fun sendEmailWithLog() {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, arrayOf("support@nuvora.app"))
        intent.putExtra(Intent.EXTRA_SUBJECT, "Nuvora Notes [Feedback]")
