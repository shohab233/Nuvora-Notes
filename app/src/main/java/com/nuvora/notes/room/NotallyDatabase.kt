...
import com.nuvora.notes.room.dao.BaseNoteDao
import com.nuvora.notes.room.dao.CommonDao
import com.nuvora.notes.room.dao.LabelDao
...
abstract class NotallyDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        /**
         * allowMainThreadQueries() is only used in [com.nuvora.notes.ReminderReceiver.onReceive]
