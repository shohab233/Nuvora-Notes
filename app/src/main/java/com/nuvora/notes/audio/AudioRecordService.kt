package com.nuvora.notes.audio
...
import com.nuvora.notes.activities.RecordAudio
import com.nuvora.notes.audio.Status.PAUSED
import com.nuvora.notes.audio.Status.READY
import com.nuvora.notes.audio.Status.RECORDING
...
class AudioRecordService : Service() {
    ...
    override fun onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channelId = "com.nuvora.audio"
